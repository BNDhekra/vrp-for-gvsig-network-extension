...
public class NetworkFileRedWriter extends AbstractNetworkWriter {
	...
	public void writeNetwork() throws BaseException {
		...
		// El campo sentido indica //3-> Doble sentido, 1-> según viene, 2
		// -> al revés, cualquier otro valor-> No hay arco
		// TipoTamo va a ser un campo numérico, entero.
		// 0-> Autopista.
		// 1-> Autovía.
		// 2-> Nacional.
		// 3-> Nacional - Comarcal.
		...
		// con su velocidad. Esa velocidad se fijará en la función
		...
		try {
			...
			// file.writeInt(0);
			output.writeInt(0);
			// OJO: El numero de arcos todavía no lo sabemos, habrá que volver
			// luego y escribir el numero correcto. Es por lo de los sentidos.
			// Metemos 2 arcos si es doble sentido, y uno si es de un solo
			// sentido

			// Guardamos un long. Luego volveremos aquí y grabaremos el nº de
			// nodos
			// file.writeInt(0);
			output.writeInt(numTramos);
